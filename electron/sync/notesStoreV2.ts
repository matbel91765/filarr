 ...
 *
 * ⚠ Un jumeau web devra exister (`src/platform/web/sync/notesStoreV2.ts`), pour
 * la même raison que `notesDelta.ts` et `notesMergeCore.ts` : la racine de
 * `electron/tsconfig.json` interdit d'importer depuis `src/`.
 */
