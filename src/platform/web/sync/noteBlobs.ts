...
/**
 * ⚠ SOURCE DE VÉRITÉ : `electron/sync/noteBlobs.ts`.
 *
 ...
 */
export function extractBlobs(content: unknown, hashOf: (base64: string) => string): ExtractResult {
 ...
 */
export function inlineBlobs(content: unknown, read: (hash: string) => string | null): InlineResult {
