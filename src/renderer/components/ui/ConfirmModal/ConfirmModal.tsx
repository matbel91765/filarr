  ...
  const getIcon = () => {
    switch (variant) {
      case 'danger':
        return (
          <svg
            className="confirm-modal__icon confirm-modal__icon--danger"
      ...
      case 'warning':
        return (
          <svg
            className="confirm-modal__icon confirm-modal__icon--warning"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
      ...
      case 'info':
        return (
          <svg
            className="confirm-modal__icon confirm-modal__icon--info"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
